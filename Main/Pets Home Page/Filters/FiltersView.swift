...
class FiltersView: UIViewController {
	...
	func setSlider() {
		...
		rangeSlider.valueChangeClosure = { (left, right) -> Void in
...
extension FiltersView: UICollectionViewDataSource {
	...
	func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "FiltersCell1", for: indexPath) as? FiltersCell1 {
...
extension FiltersView: UITableViewDataSource {
	...
	func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let cell = tableView.dequeueReusableCell(withIdentifier: "FiltersCell2", for: indexPath) as? FiltersCell2 {
